...
```sbt
"com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-api" % "0.2.1-1.6.0"
```
...
lazy val `service-api` = crossProject(JVMPlatform, JSPlatform)
  ...
  .jsSettings(
    libraryDependencies += "com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-api" % "0.2.1-1.6.0"
  )
```
...
```sbt
"com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-client" % "0.2.1-1.6.0"
```
...
lazy val `client-js` = project
  .settings(
    libraryDependencies += "com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-client" % "0.2.1-1.6.0"
  )
