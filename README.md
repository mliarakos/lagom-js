...
```sbt
"com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-api" % "0.3.2-1.6.2"
```
...
lazy val `service-api` = crossProject(JVMPlatform, JSPlatform)
  ...
  .jsSettings(
    libraryDependencies += "com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-api" % "0.3.2-1.6.2"
  )
```
...
```sbt
"com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-client" % "0.3.2-1.6.2"
```
...
lazy val `client-js` = project
  .settings(
    libraryDependencies += "com.github.mliarakos.lagomjs" %%% "lagomjs-scaladsl-client" % "0.3.2-1.6.2"
  )
